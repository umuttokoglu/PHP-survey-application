...
$anketsor=$db->prepare("SELECT Anket_Ad,Isim_Onay FROM anket WHERE Id=?");
...
$toplam=$db->prepare("SELECT Evet,Hayir FROM cevap ");
$toplam->execute(array());
while ($hayir=$toplam->fetch(PDO::FETCH_ASSOC)){ 
	$toplam_ha += $hayir['Hayir'];
	$toplam_ev += $hayir['Evet'];
}
		...
		<div class="portlet light">
			<div class="portlet-title">
				...
				<div class="col-md-offset-7">
					<a href="dbthings/excell.php?Id=<?php echo $Id; ?>&var=<?php echo $anketcek['Isim_Onay']; ?>" class="btn btn-lg blue">
								...
								<div class="table-responsive">
									<table class="table table-hover table-light">
										...
										<tbody>
											...
											$isimlisoru=$db->prepare("SELECT soru.Soru_Detay,soru.Id, cevap.Evet, cevap.Hayir, cevap.Deger FROM cevap INNER JOIN soru ON cevap.Soru_Id = soru.Id");
											$isimlisoru->execute(array());
											//
											while ($isimli=$isimlisoru->fetch(PDO::FETCH_ASSOC)) {
												$i++;
												$detay = $isimli['Soru_Detay'];
												...
												<tr>
													...
													<td>
														<?php echo $isimli['Evet']; ?> 
													</td>
													<td>
														<?php echo $isimli['Hayir']; ?> 
													</td>
													...
													<td>
														<a href="soruduzenle.php?Id=<?php echo $isimli['Id']; ?>">Soruyu düzenle.</a>
													</td>
												</tr>
